                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive mt-4" x-data="{ isDragging: false, startX: 0, scrollLeft: 0 }"
                            ...
                            <table id="tableAssetsNew" class="table table-striped table-bordered table-hover table-sm"
                                ...
                                <thead>
                                    <tr>
                                        <th scope="col" id="lokasiHeader" x-show="!isColumnHidden('lokasi')">Lokasi
                                        </th>
                                        <th scope="col" x-show="!isColumnHidden('unit')">Unit</th>
                                        <th scope="col" x-show="!isColumnHidden('No Asset')">No Asset</th>
                                        <th scope="col" x-show="!isColumnHidden('Nama Asset')">Nama Asset</th>
                                        <th scope="col" x-show="!isColumnHidden('Group Asset')">Group Asset</th>
