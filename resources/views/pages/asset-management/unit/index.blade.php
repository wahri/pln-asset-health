...
@section('content')
    ...
    <div class="page-content">
        ...
        <hr />
        <a href="{{ route('assetManagement.location.index') }}" type="button" class="btn btn-secondary mb-3 ms-2"><i
                                    ...
                                    <td class="d-flex gap-2">
                                        ...
                                        <div class="modal fade" id="editUnit_{{ $u->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form
                                                        action="{{ route('assetManagement.unitPembangkit.update', $u->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('put')
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <label for="nameUnit" class="form-label">Name
                                                                    Unit</label>
                                                                <input type="text" class="form-control" id="nameUnit"
                                                                    name="nameUnit" value="{{ $u->name }}">
                                        ...
                                        <form action="{{ route('assetManagement.unitPembangkit.destroy', $u->id) }}"
                                            method="post" id="delete-form_{{ $u->id }}">
                                            @csrf
                                            @method('delete')
                                        ...
                                        <a href="{{ route('assetManagement.assets.index', $u->id) }}"
